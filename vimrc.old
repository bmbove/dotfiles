...
" move cursor to previous position on restart
Bundle 'vim-scripts/restore_view.vim'

" Marks added, modified, and removed lines based on data from git
Bundle 'mhinz/vim-signify'

" Moves cursor to next place with input chars by s{char}{char}
